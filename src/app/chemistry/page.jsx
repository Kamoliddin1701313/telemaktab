    ...
    <div>
      <div className="bg-[linear-gradient(180deg,#f6fbff_0%,#eef6ff_100%)] h-[500px] max-xl:px-5 max-lg:h-auto max-lg:min-h-[500px]">
        <section className="max-w-[1280px] mx-auto">
          <div className="flex items-start justify-between py-20 gap-10 max-lg:flex-col max-lg:py-10">
            <motion.div
            ...
            >
              ...
              <Image
                ...
                alt="teacher"
                width={280}
                className="absolute -right-[5%] top-[30%] max-lg:top-[120%] max-lg:-left-[5%] max-md:-left-[10%] max-sm:hidden"
              />
            </motion.div>
