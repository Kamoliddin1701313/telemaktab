...
const categories = [
  {
    title: "Koinot va yulduzlar",
    desc: "Galaktikalar, yulduzlar va ularning sirli olami.",
    icon: <FaStar />,
  },
  {
    title: "Yer tuzilishi",
    desc: "Qit’alar, okeanlar va geologik jarayonlar.",
    icon: <FaMountain />,
  },
  {
    title: "Xaritalar va koordinatalar",
    desc: "Geografik xaritalar va yo‘l topish san’ati.",
    icon: <FaCompass />,
  },
  {
    title: "Materik va mamlakatlar",
    desc: "Dunyo davlatlari va ularning joylashuvi.",
    icon: <FaGlobeAfrica />,
  },
  {
    title: "Sun’iy yo‘ldoshlar",
    desc: "Kosmik tadqiqotlar va GPS texnologiyalari.",
    icon: <FaSatellite />,
  },
];
          ...
          <div className="flex items-start justify-between py-20 gap-10">
            ...
            >
              <h1 className="text-[44px] text-[#0f3b82] font-semibold leading-11">
                Astronomiya va Geografiya — olamni kashf et!
              </h1>

              <p className="text-[18px]">
                Bu yerda siz Yerni, osmon jismlarini va ularning o‘zaro
                aloqalarini o‘rganasiz. Darslarimiz sizga koinot va tabiatni
            ...
            >
              ...
              >
                ...
                <text x="10" y="160" fontSize="16" fill="rgba(255,255,255,0.5)">
                  🌞 Quyosh tizimida 8 ta sayyora mavjud
                </text>
              </svg>
            </motion.div>
          </div>
